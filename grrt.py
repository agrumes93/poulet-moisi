...
class Cercle:
    ...
    def appartient_disque(self, point):
        ...
        """
        return Cerlce.distance(self.centre, point) <= self.rayon
    def trace_cairo(self, ctx, couleur):
        ...
        ctx.arc(*self.centre, self.rayon, 0, math.tau)
        ctx.stroke()
